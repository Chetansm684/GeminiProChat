...
declare const useWebNotification: (defaultOptions?: UseWebNotificationOptions) => {
    ...
    close: () => void;
    onClick: _solidjs_use_shared.EventHookOn<any>;
    onShow: _solidjs_use_shared.EventHookOn<any>;
    onError: _solidjs_use_shared.EventHookOn<any>;
    onClose: _solidjs_use_shared.EventHookOn<any>;
};
