import { Awaitable, MaybeAccessor } from '@solidjs-use/shared';
...
interface SSRHandlersMap {
    ...
    updateHTMLAttrs: (selector: string | MaybeAccessor<HTMLElement | SVGElement | null | undefined>, attribute: string, value: string) => void;
}
