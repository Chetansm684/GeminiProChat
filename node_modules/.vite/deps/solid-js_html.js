...
// node_modules/.pnpm/solid-js@1.7.6/node_modules/solid-js/html/dist/html.js
var tagRE = /(?:<!--[\S\s]*?-->|<(?:"[^"]*"['"]*|'[^']*'['"]*|[^'">])+>)/g;
...
function createHTML(r, {
  ...
  function createTemplate(statics, opt) {
    ...
    const [html2, code] = parseTemplate(pars, opt.funcBuilder), templates = [];
